 ...
 * /training (the practice account) on success; on failure, redirects back
 * to /login with an
 * `error` query param the page reads to show a message (keeps this a plain
 * <form action={...}> with no client-side JS required to submit).
 */
